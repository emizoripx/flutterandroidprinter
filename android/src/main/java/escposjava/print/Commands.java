...
public class Commands {
   ...
   // Beeper Corto
   public static final byte[] BEEPERCORTO          = {0x1b,0x42,0x01,0x02}; // Beeps 1 beep
...
//   public static final byte[] SELECT_BIT_IMAGE_MODE = {0x1B, 0x2A, 33, Integer.valueOf(255).byteValue(), 0x3};
   ...
   public static final byte[] CHARCODE_ISO885915  = {0x1b,0x74,0x2c}; // Latin 3
