...
public class ESCUtil {
    ...
    /** * Imprimir un solo código QR comando personalizado sunmi * * código @param: datos del código QR * @param moduleize: tamaño de bloque de código QR (unidad: punto, valor 1 a 16) * @param errorlevel: dos Corrección de error de código de dimensión nivel (0 a 3) 0 - nivel de corrección de errores L (7%) 1 - nivel de corrección de errores M (15%) 2 - * nivel de corrección de errores Q (25%) 3 - nivel de corrección de errores H (30%) */
    ...
    /** * Dos comandos personalizados sunmi de código bidimensional horizontal * * @param code1: datos de código bidimensional * @param code2: datos de código bidimensional * @param moduleize: tamaño de bloque de código bidimensional (unidad: punto, valor 1 a 16) * @param errorlevel: nivel de corrección de error del código QR (0 a 3) 0 - Nivel de corrección de error L (7%) 1 - Nivel de corrección de error M (15%) 2 - * Nivel de corrección de error Q (25%) ) 3 - Nivel de corrección de errores H (30%) */
    ...
    /**
     * Código QR de impresión de trama
     */
